...
function get_top_10($duration = "day")
{
   ...
   $db = getDB();
   $query = "SELECT ROW_NUMBER() OVER(ORDER BY score DESC, Scores.created DESC) Ranking, username, score, Scores.created FROM Scores JOIN Users ON Scores.user_id = Users.id";
   if ($d === "day") {
